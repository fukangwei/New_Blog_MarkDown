...
---
&emsp;&emsp;异常是程序中的一些错误，但并不是所有的错误都是异常，并且错误有时候是可以避免的。例如你的代码少了一个分号，那么运行出来结果是提示错误`java.lang.Error`；如果你使用`System.out.println(11/0)`，用`0`做了除数，会抛出`java.lang.ArithmeticException`的异常。<!--more-->
