...
---
&emsp;&emsp;有许多东西用来构建一个优秀的`Android`应用程序。除了应用程序的编码，你需要关注各种各样的资源，诸如用到的各种静态内容(位图、颜色、布局定义、用户界面字符串、动画)。这些资源一般放置在项目的`res/`下独立子目录中。<!--more-->
